...
function sortProducts(event) {
    ...
    $.ajax({
        url: "/Final_HuyDuy_HDMotor/ShopServlet",
        type: "get",
        data: {
            valueSort: text
        },
...
function searchProducts(tag, scope) {
    ...
    var scope = scope;
    $.ajax({
        url: "/Final_HuyDuy_HDMotor/SearchServlet",
        type: "get",
        data: {
            txtSearch: text,
            scope: scope
...
function addProductToCart(action, product_id, quantity) {
    ...
    var sl = quantity;
    $.ajax({
        url: "/Final_HuyDuy_HDMotor/CartServlet",
        type: "get",
        data: {
            action: action,
...
function addProductToWishlist(action, product_id) {
    ...
    var productId = product_id;
    $.ajax({
        url: "/Final_HuyDuy_HDMotor/WishlistServlet",
        type: "get",
        data: {
            action: action,
            product_id: productId,
...
function checkDuplicate(input) {
    ...
    $.ajax({
        url: "/Final_HuyDuy_HDMotor/RegisterServlet",
        type: "post",
        data: {
            username: username,
